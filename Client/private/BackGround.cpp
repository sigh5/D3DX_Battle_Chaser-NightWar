...
HRESULT CBackGround::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_LOGO, TEXT("Prototype_Component_Texture_LogoBackGround"), TEXT("Com_Texture"),
	...
	if (FAILED(__super::Add_Component(CGameInstance::Get_StaticLevelIndex(), TEXT("Prototype_Component_Transform"), TEXT("Com_Transfrom"),
