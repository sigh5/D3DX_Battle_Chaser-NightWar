...
void CSkyBox::Late_Tick(_double TimeDelta)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_TRANSLATION, XMLoadFloat4(&pGameInstance->Get_CamPositon()));
...
HRESULT CSkyBox::Last_Initialize()
{
	return E_NOTIMPL;
}
